...
class CreatePurchaseOrderModal extends Component
{
    ...
    public function setTotal()
    {
        ...
        if (!is_null($quantityItem) && !is_null($priceUnit)) {
    ...
    public function save()
    {
        ...
        $this->dispatch('storeItem', $this->orderForm->currentSelect, $this->orderForm->priceUnit, $this->orderForm->quantityItem)->to(CreatePurchaseOrder::class);
