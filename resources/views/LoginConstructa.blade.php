...
<body class="authentication-bg position-relative">
                        ...
                        <div class="card-header pt-4 text-center">
                            <div class="auth-brand mb-0">
                                <a href="" class="logo-dark">
                                    <span><img src="assets/images/constructados.png" alt="dark logo"
                                            height="200"></span>
                                </a>
                            ...
                            <form method="POST" action="{{ route('login') }}">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" type="text" id="name" required=""
                                        placeholder="Ingresa el usuario" name="name">
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-merge">
                                        <input type="password" id="password" class="form-control"
                                            placeholder="Ingresa la contraseña" name="password">
                                ...
                                <div class="mb-3 mb-0 text-center">
                                    <button class="btn btn-primary" type="submit" name="btnlogin"> Iniciar
                                        sesión</button>
                                </div>
                            </form>
                        </div> <!-- end card-body -->
    ...
    <footer class="footer footer-alt">
        <span class="text-white-50">
            ...
            </script> © Constructa - Constructa.com
        </span>
    </footer>
    <!-- Vendor js -->
