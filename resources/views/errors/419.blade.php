                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center">
                                    ...
                                    <h1 class="text-error mt-4">Ups!</h1>
                                    <h4 class="text-uppercase text-danger mt-3">Recarga e inicia sesión nuevamente</h4>
                                    <p class="text-muted mt-3">Pasaste mucho tiempo inactivo, cerramos la sesión, puedes volver a iniciar sesión nuevamente</p>

                                    <a class="btn btn-info mt-3" href="{{ route('dashboard') }}"><i class="ri-home-4-line me-1"></i>Regresar </a>
                                </div>
