...
<html lang="en">
    ...
    <head>
        ...
        <img src="{{ asset('assets/images/svg/startman.svg') }}" />
    ...
    <body class="authentication-bg">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center">
                                    ...
                                    <h4 class="text-uppercase text-danger mt-3">Error interno de servidor</h4>
                                    <p class="text-muted mt-3">¿Por qué no intentas recargar la página? o puedes contactarnoss <a href="" class="text-muted"><b>admin@tecnoatom.com</b></a></p>

                                    <a class="btn btn-info mt-3" href="{{ route('dashboard') }}"><i class="ri-home-4-line me-1"></i> Volver</a>
                                </div>
        ...
        <footer class="footer footer-alt">
            <span class="text-white-50"><script>document.write(new Date().getFullYear())</script> © Constructa - tecnoatom.com</span>
        </footer>
