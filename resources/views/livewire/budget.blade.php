    ...
    @foreach($capitulos as $capitulo)
        ...
        @foreach($capitulo->items as $item)
            ...
            <tr>
                ...
                <td class="text-end">{{ number_format($item->vr_total, 2) }}</td>
            </tr>
        @endforeach
    ...
    @endforeach
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="chapterModalLabel">Crear capítulo e items</h5>
...
document.addEventListener('livewire:initialized', () => {
    ...
    // Reiniciar el backdrop cuando se cierra el modal manualmente
    const chapterModal = document.getElementById('chapterModal');
    chapterModal.addEventListener('hidden.bs.modal', function () {
