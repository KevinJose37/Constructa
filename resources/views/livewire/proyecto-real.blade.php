            ...
            <div class="table-responsive-sm mb-3">
                <table class="table table-bordered table-centered mb-0">
                    ...
                    <tbody>
                        ...
                        $progressDetail = $chapter->workProgressChapter
                        ? $chapter->workProgressChapter->details->firstWhere('item', $item->id)
                        : null;
                        ...
                        $hasAlert = true;
                        $textAlert = "El avance financiero del ítem {$item->item_number} superó el umbral de {$item->umbral_financiero}%. Avance actual: ".number_format($avanceFinanciero, 2)."%";
                        }
