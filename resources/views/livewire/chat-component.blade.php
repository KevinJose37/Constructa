<div>
                    ...
                    <div class="card mb-1 shadow-none border">
                        <div class="p-2">
                            <div class="row align-items-center">
                                <div class="col ps-0">
                                    <a href="{{ Storage::url($message->attachments) }}" download class="text-muted fw-bold" target="_blank">{{ $message->attachments }}</a>
                                    <p class="mb-0">{{ number_format(Storage::size($message->attachments) / 1024, 2) }} KB</p>
                                </div>
                                <div class="col-auto">
                                    <!-- Botón para eliminar el archivo adjunto -->
                                    <button wire:click="deleteAttachment('{{ $message->id }}')" class="btn btn-link fs-16 text-muted">
    ...
    <form wire:submit.prevent="saveMessage" class="dropzone" id="myAwesomeDropzone" data-plugin="dropzone" data-previews-container="#file-previews" data-upload-preview-template="#uploadPreviewTemplate">
        <div class="fallback">
    ...
    <button wire:click="saveAttachments" class="btn btn-sm btn-primary"><i class="ri-attachment-line me-1"></i>GUARDAR ADJUNTO</button>
