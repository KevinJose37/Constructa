                ...
                <tbody>
                    ...
                    <tr id="purchaseOrderRow_{{ $order->id }}" class="d-flex" data-bs-toggle="collapse" data-bs-target="#collapse{{ $order->id }}" aria-expanded="false" aria-controls="collapse{{ $order->id }}">
                        ...
                        <td style="display: flex; align-items: center;" class="col-md-1">
                            <a href="#" class="text-reset fs-19 px-1 delete-project-btn" wire:click.prevent="destroyAlert({{ $order->id }}, '{{ $order->project->project_name }}')">
                                <i class="ri-delete-bin-2-line"></i></a>
                            <a href="{{ route('purchaseorder.get', ['id' => $order->id]) }}"><i class="ri-search-eye-line"></i></a>
                        </td>
                    </tr>
                    <!-- Fila de detalles -->
