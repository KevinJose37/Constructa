                ...
                <div class="row clearfix">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control form-control-sm" id="inputApodo"
                            placeholder="Ingrese el nombre para identificar la orden de compra" wire:model="order_name">
                        @error('order_name')
                    ...
                    <div class="col">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div
                                    class="invalid-feedback {{ $errors->has('material_destination') ? 'd-block' : '' }}">
                                    {{ $message }}
                                </div>
                                @enderror
                            </div>
                        ...
                        <div class="text-sm-end">
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div
                                        class="invalid-feedback {{ $errors->has('payment_method_id') ? 'd-block' : '' }}">
                                        {{ $message }}
                                    </div>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div
                                        class="invalid-feedback {{ $errors->has('account_number') ? 'd-block' : '' }}">
                                        {{ $message }}
                                    </div>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <div
                                        class="invalid-feedback {{ $errors->has('support_type_id') ? 'd-block' : '' }}">
                                        {{ $message }}
                                    </div>
                                    @enderror
                                </div>
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-4">
                        ...
                        <p class="fs-13"><strong>Subtotal: </strong> <span>
                                ${{ number_format(floatval(str_replace(',', '.', $totalPurchase)), 2, ',', '.') }}</span></p>
